...
-- Keybinds to save files which requires root access
vim.cmd([[
  cnoremap w!! execute 'silent! write !sudo tee % >/dev/null' | if expand('%') != '' | edit! | endif
]])

-- Keybind for comenting repeating line
vim.keymap.set("n", "ycc", "yygccp", { remap = true })
vim.keymap.set("n", "yrr", "yyp", { remap = true })
...
require('lazy').setup({
  ...
  --
  {
    ...
    config = function()
      require('toggleterm').setup {
        ...
        shell = '/bin/zsh', -- Run tmux inside the terminal
      }
    end,
  },
  {
  ...
  },
  {
    ...
    config = function()
      ...
      --    cmd = { 'salt_lsp_server' }, -- Use the correct command
      --    filetypes = { 'sls', 'jinja' }, -- SaltStack and Jinja template files
      --    settings = {
      --      salt = {
      --        enable = true,
      --      },
